      ...
      return (
        ...
        (() => {
          ...
          var __webpack_modules__ = [
            ...
            /***/
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              var _onPresentationModeChanged, _AnnotationLayerBuilder_instances, updatePresentationModeState_fn;
              Object.defineProperty(exports2, "__esModule", {
                value: true
              });
              ...
              class AnnotationLayerBuilder {
                ...
                async render(viewport, intent = "display") {
                  ...
                  if (this.linkService.isInPresentationMode) {
                    __privateMethod(this, _AnnotationLayerBuilder_instances, updatePresentationModeState_fn).call(this, _ui_utils.PresentationModeState.FULLSCREEN);
                  }
            ...
            /***/
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              var _annotationMode, _hasRestrictedScaling, _layerProperties, _loadingId, _previousRotation, _renderError, _renderingState, _textLayerMode, _useThumbnailCanvas, _viewportMap, _PDFPageView_instances, setDimensions_fn, renderAnnotationLayer_fn, renderAnnotationEditorLayer_fn, renderXfaLayer_fn, renderTextLayer_fn, renderStructTreeLayer_fn, buildXfaTextContentItems_fn, finishRenderTask_fn;
              Object.defineProperty(exports2, "__esModule", {
                value: true
              });
            ...
            /***/
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              var _enablePermissions, _rotation, _scale, _textContentSource, _TextLayerBuilder_instances, finishRendering_fn, bindMouse_fn;
              Object.defineProperty(exports2, "__esModule", {
                value: true
              });
              ...
              class TextLayerBuilder {
                ...
                async render(viewport) {
                  ...
                  __privateMethod(this, _TextLayerBuilder_instances, finishRendering_fn).call(this);
                  __privateSet(this, _scale, scale);
                  __privateSet(this, _rotation, rotation);
                  this.show();
              ...
              finishRendering_fn = function() {
                ...
                __privateMethod(this, _TextLayerBuilder_instances, bindMouse_fn).call(this);
              };
            ...
            /***/
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              var _closeCapability, _destroyCapability, _docProperties, _eventBus, _externalServices, _pdfDocument, _pdfViewer, _ready, _sandboxBundleSrc, _scripting, _willPrintCapability, _PDFScriptingManager_instances, updateFromSandbox_fn, dispatchPageOpen_fn, dispatchPageClose_fn, initScripting_fn, destroyScripting_fn;
              Object.defineProperty(exports2, "__esModule", {
                value: true
              });
              exports2.PDFScriptingManager = void 0;
            ...
            (__unused_webpack_module, exports2, __w_pdfjs_require__2) => {
              ...
              class PDFViewer {
                  ...
                  Promise.all([firstPagePromise, permissionsPromise]).then(([firstPdfPage, permissions]) => {
                    ...
                    if (annotationEditorMode !== _pdfjsLib.AnnotationEditorType.DISABLE) {
                      ...
                      if (pdfDocument.isPureXfa) {
                        ...
                        __privateSet(this, _annotationEditorUIManager, new _pdfjsLib.AnnotationEditorUIManager(this.container, this.viewer, __privateGet(this, _altTextManager), this.eventBus, pdfDocument, this.pageColors));
                    ...
                    const layerProperties = __privateMethod(this, _PDFViewer_instances, layerProperties_fn).bind(this);
                    ...
                    __privateMethod(this, _PDFViewer_instances, onePageRenderedOrForceFetch_fn).call(this).then(async () => {
                      var _a3, _b3;
                      ...
                      if (__privateGet(this, _hiddenCopyElement)) {
                        __privateSet(this, _copyCallbackBound, __privateMethod(this, _PDFViewer_instances, copyCallback_fn).bind(this, textLayerMode));
                ...
                increaseScale({
                  ...
                  __privateMethod(this, _PDFViewer_instances, setScale_fn).call(this, Math.min(_ui_utils.MAX_SCALE, newScale), {
                    noScroll: false,
                    drawingDelay
                  });
                }
                decreaseScale({
                  ...
                  __privateMethod(this, _PDFViewer_instances, setScale_fn).call(this, Math.max(_ui_utils.MIN_SCALE, newScale), {
                    noScroll: false,
                    drawingDelay
                  });
                }
